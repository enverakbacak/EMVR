...
queryIndex6 = queryIndex(6,:);
 ...
 for l = 1:240 % Number of Query Pairs , CAN TRY FOR DIFFERENT HAMMING RADIUS ALSO ?????? how?
       ...
       xor_data_q5new{l,:} = xor(data, q6_rep{l,:});
       ...
       hamming_dist6{l,:} = sum(xor_data_q6new{l,:},2);
	...
	union_of_query_labels{l,:} = or(union_of_query_labels{l,:},  targets(queryIndex(6,l), : ));
       ...
       q5 = X{l,:}(queryIndex5,:); 
       q6 = X{l,:}(queryIndex6,:);   
       Cmn(l,:) = (q1(l,:) + q2(l,:) + q3(l,:) + q4(l,:)  + q5(l,:) + q6(l,:)).'/2;
       ...
       %%%%%%%%%%%%%%%%%%%%  ReRanking, rearrange P items by features  %%%%%%%%%%% 
        ...
        Retrieved_Items{l,:}(end+1,:) = queryIndex6(:,l);
        ...
        dist_f6{l,:} = pdist2(f6(l,:) , rtr_idx2_features , 'euclid' );
	...
	qf6(l,:) = YY{l,:}(end,:);
        ...
        Cmn_f(l,:) = (qf1(l,:) + qf2(l,:) + qf3(l,:) +  qf4(l,:) +  qf5(l,:) +  qf6(l,:)).'/2;
